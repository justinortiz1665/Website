...
import { getAllProjects, getAllTags, type Project } from "@/lib/projects"
...
export default function PortfolioSection() {
  ...
  useEffect(() => {
    if (selectedTags.length === 0) {
      ...
      const filtered = allProjects.filter((project) => project.tags.some((tag) => selectedTags.includes(tag)))
